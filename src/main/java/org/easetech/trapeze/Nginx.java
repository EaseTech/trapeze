...
/**
 * @author anuj
 * READ : https://www.digitalocean.com/community/tutorials/how-to-install-nginx-on-ubuntu-12-04-lts-precise-pangolin
 * 
 * https://www.digitalocean.com/community/tutorials/how-to-install-nginx-on-ubuntu-12-04-lts-precise-pangolin
 *
 *GENERATE SSL CERTIFICATES : https://www.digitalocean.com/community/tutorials/how-to-create-a-ssl-certificate-on-nginx-for-ubuntu-12-04
...
public class Nginx {
	...
	public static void main(String[] arg) {
		...
		commands.add("sudo apt-get install nginx");
//		commands.add("sudo apt-get update");
...
//			}
			...
			String command = "sudo service nginx start";
//			Iterator<String> commandsItr = commands.iterator();
//			while (commandsItr.hasNext()) {
//				command = command.append(commandsItr.next()).append(" && ");
//			}
